...
static FLOAT intwatab[ANZ_W_A + 1];
#ifdef TIMEDEPGRAV
static FLOAT dHtab[ANZ_W_A_IN];
static FLOAT dGtab[ANZ_W_A_IN];
static FLOAT intdHtab[ANZ_W_A + 1];
static FLOAT intdGtab[ANZ_W_A + 1];
#endif
#ifdef EXTERNALHUBBLE
static FLOAT Htab[ANZ_W_A_IN];
static FLOAT intHtab[ANZ_W_A + 1];
#endif
