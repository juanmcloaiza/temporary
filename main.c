...
int main(int argc, char **argv)
{
  ...
  All.CPU_SEv = All.CPU_Eff_Iter = All.CPU_SN_info = All.CPU_EE_info = All.CPU_SN_find =  All.CPU_SN_NeighFind = 
    All.CPU_SN_NeighCheck = All.CPU_SN_Spread = All.CPU_SN_Calc = All.CPU_SN_Comm = All.CPU_SN_Imbalance = 0;
#endif
