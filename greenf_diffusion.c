      ...
      if(P[n].Type == 0)
	{
	  ...
	  egysum += SphP[n].CR_E0;
          ...
          if(All.CR_DiffusionDensScaling != 0.0)
            kappa *= pow(SphP[n].a2.Density * a3inv / All.CR_DiffusionDensZero, All.CR_DiffusionDensScaling);
	  ...
	  if(SphP[n].CR_E0 > 0)
	    {
	      CR_q_i = SphP[n].CR_q0 * pow(SphP[n].a2.Density * a3inv, 0.33333);
	  ...
	  if(SphP[n].CR_n0 > 1.0e-12 && SphP[n].CR_E0 > 0)
	    {
	      ...
	      SphP[n].CR_q0 = qmeanKin * pow(SphP[n].a2.Density * a3inv, -(1.0 / 3.0));
